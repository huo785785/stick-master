package com.handmark.pulltorefresh.library.stickyview;
...
/**
 * 
* @ClassName: StickyScrollView
* @Description: 用一句话描述该文件做什么
* @author tanlifei 
* @date 2015年2月10日 上午11:31:43
*
 */
	...
	public StickyScrollView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
    		...
    		mShadowHeight = a.getDimensionPixelSize(
        		R.styleable.StickyScrollView_stuckShadowHeight2,
        		defaultShadowHeightInPix);

    			int shadowDrawableRes = a.getResourceId(
        		R.styleable.StickyScrollView_stuckShadowDrawable2, -1);

...
public class PullUpAndDownListView extends ListView implements OnScrollListener{
	...
	public PullUpAndDownListView(Context context, AttributeSet attrs, int defStyle) {

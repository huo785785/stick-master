...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected  T createRefreshableDeleteView(Context context, AttributeSet attrs){return null;};
	
	protected  T createRefreshableUpAndDownView(Context context, AttributeSet attrs){return null;};
	
	protected  T createRefreshableDeleteUpAndDownView(Context context, AttributeSet attrs){return null;};
	
	protected  T createStickScrollView(Context context, AttributeSet attrs){return null;};
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrDeleteView)) {
			boolean isDeleteView = a.getBoolean(R.styleable.PullToRefresh_ptrDeleteView, false);
			if (isDeleteView) {
				mRefreshableView = createRefreshableDeleteView(context, attrs);
			}else{
				mRefreshableView = createRefreshableView(context, attrs);
			}
		}else if(a.hasValue(R.styleable.PullToRefresh_ptrUpAndDown)){
			boolean isUpAndDown = a.getBoolean(R.styleable.PullToRefresh_ptrUpAndDown, false);
			if (isUpAndDown) {
				mRefreshableView = createRefreshableUpAndDownView(context, attrs);
			}else{
				mRefreshableView = createRefreshableView(context, attrs);
			}
		}else if(a.hasValue(R.styleable.PullToRefresh_ptrDeleteUpAndDown)){
			boolean isDeleteUpAndDown = a.getBoolean(R.styleable.PullToRefresh_ptrDeleteUpAndDown, false);
			if (isDeleteUpAndDown) {
				mRefreshableView = createRefreshableDeleteUpAndDownView(context, attrs);
			}else{
				mRefreshableView = createRefreshableView(context, attrs);
			}
		}else if(a.hasValue(R.styleable.PullToRefresh_ptrStickScrollView)){
			boolean isStickScrollView = a.getBoolean(R.styleable.PullToRefresh_ptrStickScrollView, false);
			if (isStickScrollView) {
				mRefreshableView = createStickScrollView(context, attrs);
			}else{
				mRefreshableView = createRefreshableView(context, attrs);
			}
		}else{
